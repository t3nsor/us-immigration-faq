...
Recall that most nonimmigrants may file to [extend their stay](general.md#can-i-extend-my-nonimmigrant-status-without-leaving-the-us) if they have been maintaining their status up until the point when the application to extend stay is filed. If a nonimmigrant has filed for [adjustment of status](green-card.md) then they usually will not be able to extend their stay any further since they will become subject to [INA 214(b)](https://www.law.cornell.edu/uscode/text/8/1184#b). As a special exception, since L-1, L-2, and H-1B nonimmigrants, and the H-4 dependents of H-1B nonimmigrants, are exempt from INA 214(b), they can continue to extend their nonimmigrant status even after they have filed for adjustment of status [36][37][38] provided that all other requirements are met.

It is common for L-1, L-2, H-1B, and H-4 nonimmigrants to continue extending their stay while they wait for a final decision to be made on their adjustment of status application. In order to be eligible for extension of stay, they must still be maintaining their status at the time when the extension application is filed. For example, an H-1B or L-1 nonimmigrant who has been unemployed for over 60 days would no longer be maintaining status, and therefore could not obtain an extension. A question that is often asked is: if an H-1B, H-4, L-1, or L-2 nonimmigrant has a C09 EAD (pending adjustment of status), and they use that EAD to work, would they be failing to maintain their status?

We should be clear, first of all, that this question is about C09 EADs. Obviously, if an L-2 spouse uses an A18 EAD, then they would not be violating status, since the A18 EAD is specifically issued to L-2 spouses in order to allow them to work. Similarly, if an H-4 spouse uses a C26 EAD, that would not cause them to violate status.

It's also clear that if an H-1B or L-1 nonimmigrant uses their C09 EAD to *leave* their employer and begin work for a new employer, instead of having their new employer file an I-129 petition for them, then they would no longer be maintaining their nonimmigrant status [39]. If an H-1B or L-1 nonimmigrant violates their status, any H-4 or L-2 dependents of that nonimmigrant would also lose their nonimmigrant status as a consequence.

However, there has been some controversy over the following questions:

1. If an H-1B or L-1 nonimmigrant, while continuing to work at their primary job, uses a C09 EAD to take up side employment, would they be violating their status?
2. If an H-4 or L-2 nonimmigrant uses a C09 EAD to work, would they be violating their status?

Here, we wish to reiterate that nothing on this page constitutes legal advice. Furthermore, in the opinion of many lawyers, the answer to both questions above is <q>yes</q> (*i.e.*, you should not do these actions if you want to maintain your status). However, in the opinion of the authors of this page, the answer to both questions is <q>no</q> (*i.e.,* you can maintain status even if you do these actions).

Consider [8 CFR §214.1(e)](https://www.law.cornell.edu/cfr/text/8/214.1#e):
...
Based on this paragraph, it is clear that an H-4 or L-2 nonimmigrant who works without authorization would be violating their status, since they do not have <q>a nonimmigrant classification which authorizes employment</q>, and they also have not been <q>granted permission to engage in employment</q>. However, an H-4 or L-2 nonimmigrant who is working using *any* valid EAD, including a C09 EAD, has been <q>been granted permission to engage in employment</q>. Therefore, this paragraph does not indicate that such a nonimmigrant would be violating their status. In addition, there are no known reports of an H-4 or L-2 nonimmigrant being denied an extension of their status on the basis of having used a C09 EAD for employment. There is at least one report of an H-4 nonimmigrant obtaining an extension of their status after having used a C09 EAD for employment [40]. Thus, in the opinion of the authors of this page, **an H-4 or L-2 nonimmigrant may use their C09 EAD without violating their status.**

Similarly, if an H-1B or L-1 nonimmigrant continues to work at their primary job (*i.e.,* the job that the petition for their nonimmigrant status is based on), and also takes up additional employment using their C09 EAD, then that nonimmigrant has <q>a nonimmigrant classification which authorizes</q> their primary employment, and has also been <q>granted permission to engage in employment</q>, allowing them to do their side job. None of the employment is unauthorized. Therefore, there is nothing in the paragraph that says that such an H-1B or L-1 nonimmigrant fails to maintain their status. One H-1B nonimmigrant has also reported being told by USCIS directly that they can maintain their status if they use the EAD for additional jobs, as long as they don't interfere with the primary job [41]. Thus, in the opinion of the authors of this page, **an H-1B or L-1 nonimmigrant may use their C09 EAD without violating their status, as long as they meet all other requirements**&mdash;mainly, that they continue to do the job that their I-129 petition is based on, or change employers based on a new I-129.

The counterarguments seem to be without merit, as there is ultimately nothing in the law or the regulations that says that using the EAD is a failure to maintain status. The most nonsensical argument is the one that says that as soon as you use your EAD, you <q>switch</q> from your H/L status to <q>EAD status</q>. As we've explained on this page already, EAD is **not** a status. An EAD is simply evidence of employment authorization, which you may have either based on your status alone or because you applied for employment authorization from USCIS and it was granted to you.

It does appear, however, that USCIS may treat the compelling circumstances EAD (C35 and C36) differently. In some ways, USCIS seems to treat the compelling circumstances EAD as a pseudo-status (for example, C36 is like the <q>dependent status</q> of C35 as described in the previous section). The Federal Register article that announced the introduction of the compelling circumstances EAD [42] also mentions several times that nonimmigrants may lose their nonimmigrant status if they use a compelling circumstances EAD. There are also some indications, however, that USCIS may not have intended for this to be categorically true. In the opinion of the authors of this page, the issue of whether using a compelling circumstances EAD causes a status violation is currently unresolved.
