...
A revoked I-140 cannot be used as the basis for I-485 portability [40] and the revocation of the I-140 will cause the I-485 to be denied. However, if the I-140 is withdrawn, there are two rules that can help protect you:

1. If the I-140's withdrawal occured more than 180 days after it was approved, then the I-140 *is not revoked* by the withdrawal [20]. Therefore, if the I-485 is already pending at the time when the I-140 is withdrawn, *and* the I-140 was already pending for 180 days at that point, then the applicant may still eventually be able to request portability (*i.e.,* once the I-485 has been pending 180 days). [17]
2. If the I-140's withdrawal occurred when the associated I-485 had already been pending for at least 180 days, then, in this case, the applicant also retains eligibility for portability [17][20]. In other words, once the applicant becomes eligible to port at the 180 day mark, the applicant will retain said eligibility even if the I-140 is withdrawn.

If neither of these two rules applies to your situation, then, as above, your I-485 will be denied after the corresponding I-140 is withdrawn. Please keep in mind, however, that this only applies to the I-140 that is used as the basis for the I-485. If any earlier I-140s, which were solely used for priority date, were withdrawn, then this would not affect the I-485.

Note that in the first scenario, if the I-485 has not been pending for 180 days at the time when the I-140 is withdrawn, then even though the I-140 remains valid for porting purposes, the I-485 cannot be approved based on that job offer, because that job offer has been rescinded [37]. This means that if the I-485 adjudication occurs prior to the 180 day mark, the I-485 will be denied. There are ways for the applicant to prevent this scenario. Let's consider an example:

Suppose that Form I-140 is approved on May 15, 2019, Form I-485 is filed based on the approved I-140 on Oct 1, 2019, and on Dec 2, 2019, the employee is fired and Form I-140 is withdrawn since the I-140 employer no longer intends to employ the I-485 applicant. Here, since the withdrawal occurred more than 180 days after approval, the regulations state that the I-140 still remains valid for porting purposes. In most cases, the applicant should get a new job offer ASAP, and wait until the I-485 has been pending 180 days (since Form I-485 usually takes more than 6 months to adjudicate in the normal course of USCIS processing). At that point, Supplement J could be filed prospectively or could be provided to USCIS on demand, to request portability based on the new job offer.
...
Alternatively, suppose that on Feb 24, 2020, USCIS sends an RFE asking for Supplement J. Usually, applicants are given a 90 day time frame to respond to an RFE. Therefore, the applicant should not attempt to submit Supplement J immediately, but should instead wait until the end of March, at which point the I-485 has been pending 180 days. Then, the applicant should prepare Supplement J with their new employer and submit it in response to the RFE. Since the I-485 has been pending for 180 days, this is a valid response [38].

However, if USCIS sent the RFE for Supplement J on Dec 9, 2019, the applicant would be out of options, since the deadline to respond to the RFE would be *before* the 180 day mark. In that case, they would probably have to have their new employer file a new labor certification, then file a new I-140 and I-485.
...
You may still be worried about this scenario; can we really be sure that USCIS would not deny portability on the basis that the original job offer disappeared before the 180 day mark? (TODO: find some specific experiences and link them here!)
