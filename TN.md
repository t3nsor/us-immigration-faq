...
If a TN nonimmigrant is in the United States and wishes to switch to a different employer, or to add a new employer they will work for concurrently, the new employer must file Form I-129 [24][25] with the same supporting documentation that would be required for an initial admission. The TN nonimmigrant must also provide copies of their most recent two paystubs, which will be filed as evidence with the I-129 that they were maintaining status at the time of filing. TN status does not have a "portability" provision like H-1B status does, so employment with the new employer may not begin until the Form I-129 is approved.

A Canadian citizen may also depart the United States and have the request for new employment adjudicated at a port of entry with the appropriate documentation [26][27]. This option&mdash;namely, having the request for new employment adjudicated at a port of entry&mdash;also appears to be open to Mexican citizens, although only if their TN visa has not yet expired [26][29].

A Mexican citizen can have the request for new employment adjudicated at a consular post (presumably, this option is also open to Canadian citizens, though rarely used). If this request is approved, the new employer will be added as an annotation on the TN visa [28]. Of course, it is also permissible to apply for a new TN visa, and this would be required if the old visa had already expired.
...
There is no limit on the number of times that TN status can be "renewed". However, lengthy periods of stay in TN status may eventually result in the TN nonimmigrant no longer being able to overcome the presumption of immigrant intent, resulting in a denial of further TN visa renewals or subsequent admissions at the port of entry [34][35][36]. The *Foreign Affairs Manual* states that TN applicants are required to "demonstrate ... their maintenance of a residence abroad" but this requirement is not consistently enforced, and may be an error, as the requirement to maintain a residence abroad is not found in the Immigration and Nationality Act [38], and elsewhere in the *FAM*, it is stated that it does not apply to TN applicants [37].

Although it is conceded that extended periods of stay in TN status may eventually result in a denial, there does not appear to be any specific guidance regarding how long is too long. There are, however, anecdotal reports of being denied admission as a result of admitting to CBP officers in some way that their intent is non-temporary. It is therefore recommended that applicants for TN status should, upon each instance of seeking entry (including the very first one) be prepared to, if questioned by the officer, make *truthful* statements consistent with the following:
...
1. That the applicant might have a family emergency or other circumstance requiring them to travel abroad after the I-485 filing but before advance parole is granted (which takes a few months). Such an alien would not only abandon their I-485, but would have difficulty in being re-admitted in TN status since they recently demonstrated an unambiguous intent to immigrate (even if temporarily abandoned).
2. That the applicant, after receiving advance parole, travels and returns to the US and their I-485 is denied. Such an applicant, having not been admitted, would not be eligible to retry filing the I-485 [45][46]. Instead, they would typically be forced to depart the US and apply for an immigrant visa at a consular post in lieu of re-filing the I-485, which could disrupt their employment and family ties in the US.
3. That the applicant's TN status would expire while Form I-485 is pending; the subsequent denial of the I-485 would then pose issues similar to those described in item 2. However, this risk can be minimized by proper timing (*i.e.,* so that your I-94 will still be valid for 2+ years at the time that Form I-485 is filed). In particular, for Rest of World applicants (born in neither India nor China), it's usually possible to complete the entire green card process before the initial 3-year period of admission expires.
