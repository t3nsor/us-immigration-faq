...
In lieu of filing for a change of employer with USCIS, a Canadian citizen may simply depart the United States and have the request for new employment adjudicated at a port of entry with the same documentation that would be required for a first-time TN application (see above) [26][27]. Mexican citizens may also avail themselves of this option [25][26][29][30][31] as long as their TN visa is still unexpired or [automatic revalidation](visas.md#under-which-circumstances-can-an-expired-visa-be-used-to-enter-the-us) applies. Should this not be the case, the Mexican citizen cannot re-enter the US as a TN nonimmigrant professional without first obtaining a new TN visa.
