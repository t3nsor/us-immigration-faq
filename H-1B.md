...
According to paragraph 3(i) of the proclamation, a person who was in the US on June 24, 2020 at 12:01 AM ET should still be eligible to travel outside the US and renew their visa. However, when asked for clarification about this issue, the @travelgov Twitter account, on multiple occasions, replied with <q>we will not be issuing H-1B, H-2B, L, or certain J visas, and their derivatives through December 31 unless an exception applies.</q> (See for example [68]). Observers interpreted this to mean that the State Department decided, without legal authority, that they would not honour the exception in paragraph 3(i). It is thus also not clear whether they would honour the exception in paragraph 3(ii), for individuals who already had a valid visa on June 24, 2020 and who seek a new H-1B visa after that date. Nevertheless, a person who was outside the US on June 24, 2020 at 12:01 AM ET, but has a valid H-1B visa, can still use it to enter the US.

The proclamation also applies to the issuance of H-4 visas for dependents of H-1B nonimmigrants. However, the proclamation was not clear about dependents. Some observers read it to imply that if the H-1B principal is exempt from the proclamation, then their H-4 dependents would also be considered exempt. On July 16, 2020, the State Department clarified that H-4 visas can be issued to dependents if the H-1B principal is exempt [67], which appears to confirm this point of view. The State Department also said that dependents could receive H-4 visas if the principal is already in the US. In any case, a person who has a valid H-4 visa and who remains eligible for H-4 status can still use their valid visa to enter the US.
