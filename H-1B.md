...
In this scenario, for a 240 day period after the previous petition expires, the alien is authorized to continue employment with the same employer (such employment is not considered <q>unauthorized</q>). Again, while the extension is pending, employment authorization continues **only for up to 240 days after the expiration of the petition** [44] (whereas, as discussed in the previous answer, there is no such 240 day limit if a petition is filed for *new* employment). USCIS makes an effort to adjudicate extension petitions within 240 days, and even [suspended premium processing](https://www.uscis.gov/news/uscis-extends-and-expands-suspension-premium-processing-h-1b-petitions-reduce-delays) at one point in order to prioritize petitions that were approaching 240 days of pendency. However, in rare cases where the 240 day clock runs out, **you can still stay in the US, but you can't work.** This is because of the general rule about extensions mentioned in the previous paragraph.
...
According to paragraph 3(i) of the proclamation, a person who was in the US on June 24, 2020 at 12:01 AM ET should still be eligible to travel outside the US and renew their visa. The State Department initially stated, through the @travelgov Twitter account, that <q>we will not be issuing H-1B, H-2B, L, or certain J visas, and their derivatives through December 31 unless an exception applies.</q> (See for example [68]), which observers interpreted to mean that the State Department decided, without legal authority, that they would not honour the exception in paragraph 3(i). However, on July 17, 2020, @travelgov stated that individuals who were inside the US, and maintaining lawful H-1B status, on June 24, 2020, would indeed be eligible to renew their H-1B visa stamps [70], consistent with the proclamation.

The proclamation also applies to the issuance of H-4 visas for dependents of H-1B nonimmigrants. The text of proclamation was not clear about dependents and the State Department was, at least initially, also not been completely clear on their interpretation of the proclamation. On July 17, 2020, the State Department clarified that H-4 visas can be issued to dependents on the basis of a national interest exemption if the H-1B principal is exempt and if the principal is already in the US or already has a valid visa [67]. Separately, the State Department also explicitly stated that, if an H-1B principal had a valid visa on June 24, 2020 and that visa is still valid, their dependents may receive H-4 visas [69], and that if an H-1B principal was in the US on June 24, 2020, their dependents may receive H-4 visas [71]. It thus appears that, in general, if a principal is exempt from the ban, then the State Department will consider their dependents to be exempt as well.

In any case, a person who has a valid H-1B visa and who remains eligible for H-1B status, or who has a valid H-4 visa and remains eligible for H-4 status, can still use their valid visa to enter the US.
