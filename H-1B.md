...
The [general rules about I-94 expiration with a pending extension](general.md#what-happens-if-my-nonimmigrant-status-expires-while-my-change-of-status-extension-of-stay-or-adjustment-of-status-application-is-pending) apply to this scenario. Provided that the extension was timely filed and the alien did not engage in any unauthorized employment, the alien will be protected from accrual of unlawful presence as long as the extension remains pending; if it is denied after the previous I-94 expired, then unlawful presence will only begin to accrue *after* the portability petition is denied.
...
One should be aware that denials became more likely in 2017 following new USCIS [guidance](https://www.uscis.gov/sites/default/files/USCIS/Laws/Memoranda/2017/2017-10-23Rescission-of-Deference-PM6020151.pdf) instructing adjudicators not to defer to prior approvals.
